...
1. **Formal identity**: Math is literally the same
2. **Structural analogy**: Math has same form, different content
3. **Metaphorical similarity**: Words similar, math isn't

Only #1 and #2 are scientifically productive.
