...
MAGELLAN runs entirely within \textbf{Claude Code} (Anthropic's agentic CLI), which provides the agent dispatch infrastructure, tool access control, and hook-based quality enforcement. The 22 sessions reported in this paper were conducted using Claude Code versions 2.1.75 through 2.1.90 (January--April 2026).
