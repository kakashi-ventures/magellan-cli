...
After scoring, the top 5 (all 4, since only 4 survive) are examined for mechanistic clustering:
...
With 4 hypotheses, there are 6 pairwise comparisons (4×3/2 = 6). For each pair, the question is: which hypothesis would a senior faculty reviewer at a research-intensive university choose to test first, and why?
